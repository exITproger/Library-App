...
// --- Кнопка закрытия слева сверху ---
    ...
    {
        this.Hide();
        CentralTraditionsForm russianOmensForm = new CentralTraditionsForm();
        russianOmensForm.FormClosed += (s, args) => this.Show(); // Чтобы снова показать текущую форму при закрытии новой
        russianOmensForm.Show();
    };
