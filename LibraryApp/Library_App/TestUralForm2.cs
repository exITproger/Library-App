...
{
    public partial class TestUralForm2 : Form
    {
        ...
        public TestUralForm2()
        {
            ...
            backgroundImage.Image = Properties.Resources.fon_bashkiri;
            ...
            lblAsk1.Paint += (sender, e) =>
            {
                ...
                Color borderColor = ColorTranslator.FromHtml("#39b54a"); // Цвет рамки
        ...
        private void ReturnToDistrict()
        {
            ...
            {
                if (!(form is UralMainForm || form is RegionMapForm || form is MainMenuForm || form is MapForm))
                {
                    form.Close();
                    GC.Collect();
                }
            ...
            var uralMainMenu = Application.OpenForms.OfType<UralMainForm>().FirstOrDefault();
            if (uralMainMenu == null)
            {
                uralMainMenu = new UralMainForm();
                uralMainMenu.Show();
            }
            else
            {
                uralMainMenu.BringToFront();
            }
