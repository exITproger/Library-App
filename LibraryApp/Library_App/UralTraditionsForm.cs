...
{
    public partial class UralTraditionsForm : Form
    {
        ...
        public UralTraditionsForm()
        {
            ...
            try
            {
                this.BackgroundImage = Properties.Resources.bashkiri_traditions;
        ...
        private void LoadButtonImages()
        {
            try
            {
                btnBack.Image = Properties.Resources.UralBack;
                btnForward.Image = Properties.Resources.UralNext;
            }
            catch (Exception ex)
            {
