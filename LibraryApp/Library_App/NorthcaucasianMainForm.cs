...
namespace Library_App
{
    public partial class NorthcaucasianMainForm : Form
    {
        ...
        public NorthcaucasianMainForm()
        {
            ...
            try
            {
                this.BackgroundImage = Properties.Resources.NorthCaucasusMain;
        ...
        private void BtnForward_Click(object sender, EventArgs e)
        {
            ...
            NorthcaucasianClotherForm centralClothesForm = new NorthcaucasianClotherForm();

            centralClothesForm.ShowDialog();
