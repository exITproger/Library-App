...
{
    public partial class TestNorthcaucasianForm2 : Form
    {
        ...
        public TestNorthcaucasianForm2()
        {
        ...
        private async void btnVar2_Click(object sender, EventArgs e)
        {
            ...
            using (var choiceForm = new ChoiceFormNC())
            {
                choiceForm.ShowDialog();

                if (choiceForm.Result == ChoiceFormNC.ChoiceResult.ReturnToDistrict)
                {
                    ReturnToDistrict();
                }
                else if (choiceForm.Result == ChoiceFormNC.ChoiceResult.ReturnToRussiaMap)
                {
                    ReturnToRussiaMap();
                }
            }
        ...
        private void ReturnToDistrict()
        {
            ...
            {
                if (!(form is NorthcaucasianMainForm || form is RegionMapForm || form is MainMenuForm || form is MapForm))
                {
                    form.Close();
                    GC.Collect();
                }
            ...
            var northcaucasionMainMenu = Application.OpenForms.OfType<NorthcaucasianMainForm>().FirstOrDefault();
            if (northcaucasionMainMenu == null)
            {
                northcaucasionMainMenu = new NorthcaucasianMainForm();
                northcaucasionMainMenu.Show();
            }
            else
            {
                northcaucasionMainMenu.BringToFront();
            }
    ...
    public class ChoiceFormNC : Form
    {
