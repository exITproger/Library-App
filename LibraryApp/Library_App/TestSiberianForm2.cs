...
{
    public partial class TestSiberianForm2 : Form
    {
        ...
        public TestSiberianForm2()
        {
            ...
            backgroundImage.Image = Properties.Resources.SibiriaBackground;
        ...
        private void ReturnToDistrict()
        {
            ...
            var siberianMainMenu = Application.OpenForms.OfType<SiberianMainForm>().FirstOrDefault();
            if (siberianMainMenu == null)
            {
                siberianMainMenu = new SiberianMainForm();
                siberianMainMenu.Show();
            }
            else
            {
                siberianMainMenu.BringToFront();
            }
    ...
    public class ChoiceFormSib : Form
    {
