...
{
    public partial class SouthernClotherForm : Form
    {
        ...
        public SouthernClotherForm()
        {
            ...
            try
            {
                this.BackgroundImage = Properties.Resources.SouthClother;
        ...
        private void LoadButtonImages()
        {
            try
            {
                btnBack.Image = Properties.Resources.SouthBack;
                btnForward.Image = Properties.Resources.SouthNext;
            }
            catch (Exception ex)
            {
        ...
        private void BtnForward_Click(object sender, EventArgs e)
        {
            ...
            SouthernOmensForm open = new SouthernOmensForm();
